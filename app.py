...
def request_album_creation():
  ...
  request_album(album)
  return jsonify("<html><meta charset="utf-8"><head><style>body{background-image:url('https://s-media-cache-ak0.pinimg.com/564x/de/78/29/de78295e4c79d305ae32e733b4adbb6d.jpg');}h1  {color: DarkSlateBlue;}</style></head><body><h1>Zdjęcia zostały wysłane! </h1></body></html>")
